...
impl<PointId: crate::Identifier> Subpath<PointId> {
	...
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#subpath/evaluate/solo" title="Evaluate Demo"></iframe>
	...
	/// If this needs to be called frequently with a ray of the same rotation angle, consider instead using [`Self::ray_test_crossings_count_prerotated`].
	...
	/// If that isn't important, use [`Self::ray_test_crossings_count`] which provides an easier interface by taking a ray direction vector.
	...
	/// If this needs to be called frequently, consider instead using [`Self::point_inside_prerotated`] and moving this function's setup code into your own logic before the repeated call.
	...
	/// If that isn't important, use [`Self::point_inside`] which provides an easier interface.
	...
	/// This is faster than calling [`Self::rectangle_intersections`]`.len()` because it short-circuits as soon as an intersection is found.
	...
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#subpath/inside-other/solo" title="Inside Other Subpath Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#subpath/tangent/solo" title="Tangent Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#subpath/normal/solo" title="Normal Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#subpath/local-extrema/solo" title="Local Extrema Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#subpath/bounding-box/solo" title="Bounding Box Demo"></iframe>
	...
	/// The list of `t`-values returned are filtered such that they fall within the range `[0, 1]`.
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#subpath/inflections/solo" title="Inflections Demo"></iframe>
	...
	pub fn poisson_disk_points(&self, separation_disk_diameter: f64, rng: impl FnMut() -> f64) -> Vec<DVec2> {
		...
		let (width, height) = (bb[1] - bb[0]).into();
		...
		let point_in_shape_checker = |point: DVec2| {
			if point.x < 0. || point.y < 0. || width < point.x || height < point.y {
				return false;
			}

			shape.winding_order(point) != 0
		};

		let square_edges_intersect_shape_checker = |corner1: DVec2, size: f64| {
			let corner2 = corner1 + DVec2::splat(size);
			shape.rectangle_intersections_exist(corner1, corner2)
		};
	...
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#subpath/curvature/solo" title="Curvature Demo"></iframe>
