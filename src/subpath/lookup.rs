...
impl<PointId: crate::Identifier> Subpath<PointId> {
	...
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#subpath/lookup-table/solo" title="Lookup-Table Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#subpath/length/solo" title="Length Demo"></iframe>
	...
	/// - `tolerance` - Tolerance used to approximate the curve.
	/// - `always_closed` - consider the subpath as closed always.
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#subpath/length-centroid/solo" title="Length Centroid Demo"></iframe>
	...
	///
	/// **NOTE**: if an intersection were to occur within an `error` distance away from an anchor point, the algorithm will filter that intersection out.
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#subpath/area-centroid/solo" title="Area Centroid Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#subpath/project/solo" title="Project Demo"></iframe>
