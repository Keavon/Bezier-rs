...
impl Bezier {
	...
	/// Convert a euclidean distance ratio along the `Bezier` curve to a parametric `t`-value.
	/// For performance reasons, this version of the [`Self::euclidean_to_parametric`] function allows the caller to
	...
	///
	/// - `tolerance` - Tolerance used to approximate the curve.
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#bezier/length-centroid/solo" title="Length Centroid Demo"></iframe>
