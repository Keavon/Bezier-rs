...
impl Bezier {
	...
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#bezier/de-casteljau-points/solo" title="De Casteljau Demo"></iframe>
	...
	pub(crate) fn parametric_polynomial(&self) -> (Polynomial<4>, Polynomial<4>) {
		match self.handles {
	...
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#bezier/derivative/solo" title="Derivative Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#bezier/tangent/solo" title="Tangent Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="350px" src="https://keavon.github.io/Bezier-rs#bezier/curvature/solo" title="Curvature Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#bezier/local-extrema/solo" title="Local Extrema Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#bezier/bounding-box/solo" title="Bounding Box Demo"></iframe>
	...
	/// The list of `t`-values returned are filtered such that they fall within the range `[0, 1]`.
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#bezier/inflections/solo" title="Inflections Demo"></iframe>
	...
	/// If this needs to be called frequently with a line of the same rotation angle, consider instead using [`Self::line_test_crossings_prerotated`] and moving this function's setup code into your own logic before the repeated call.
	...
	/// If that isn't important, use [`Self::line_test_crossings`] which wraps this and provides an easier interface by taking a line rotation vector.
	...
	/// If this needs to be called frequently with a ray of the same rotation angle, consider instead using [`Self::ray_test_crossings_prerotated`] and moving this function's setup code into your own logic before the repeated call.
	...
	/// This version of the function is for better performance when calling it frequently without needing to change the rotation between each call.
	/// If that isn't important, use [`Self::ray_test_crossings`] which wraps this and provides an easier interface by taking a ray direction vector.
	...
	/// <iframe frameBorder="0" width="100%" height="325px" src="https://keavon.github.io/Bezier-rs#bezier/intersect-self/solo" title="Self Intersection Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#bezier/intersect-rectangle/solo" title="Intersection (Rectangle) Demo"></iframe>
	...
	/// <iframe frameBorder="0" width="100%" height="300px" src="https://keavon.github.io/Bezier-rs#bezier/join/solo" title="Join Demo"></iframe>
